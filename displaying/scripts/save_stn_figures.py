...
for col in columns:
    for extra_time in [30, 180]:
        ...
        try:
            ...
            ext = end + dt.timedelta(0,60*extra_time) # 30 min
            ...
            # save figure
            plt.savefig('../../../antarctica_data/figures/'+col+'_'+str(extra_time)+'_interp_period.png', dpi=350)
            
        except:
            print(col, extra_time)
